...
| CAT-02 | Price/duration/capacity override theo unique service + vehicle type và snapshot | Spec §7.3; DEC-016 | MUST | Pricing / 02,06,07 | `database/migrations/002_create_catalog_tables.php`, `app/Services/ServiceCatalogService.php`, `app/Repositories/ServiceCatalogRepository.php` | `DatabaseFoundationTest`, `CatalogSlotFlowTest`; booking snapshot tiếp tục Slice 07 | DEMO-02 | In Progress |
| SLOT-01 | Capacity = max(default, service overrides), không cộng; mọi slot chồng lấn phải đủ | Spec §7.3; DEC-017 | MUST | Slot / 06,07 | `app/Services/WashSlotService.php`, `app/Repositories/WashSlotRepository.php`, `database/seeds/base.php` | `CatalogSlotFlowTest`, `WashSlotValidatorTest`; multi-slot tiếp tục Slice 07 | DEMO-02 | In Progress |
