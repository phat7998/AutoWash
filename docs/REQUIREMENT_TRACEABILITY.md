...
| LOY-02 | Ledger + allocation + balance cache atomic; adjust/redeem không âm hoặc clamp | Spec §7.5; DEC-011/018/032 | MUST | Loyalty / 09 | `app/Services/LoyaltyService.php`, `app/Repositories/LoyaltyTransactionRepository.php`, `scripts/reconcile-loyalty.php` | `LoyaltyFlowTest`; redeem/allocation tiếp tục Slice 10 | DEMO-04 | In Progress |
