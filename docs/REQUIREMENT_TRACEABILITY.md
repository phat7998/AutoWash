...
| BKG-03 | Server price; một perk/promo/reward; final ≥0 | Spec §7.4 | MUST | Booking+Pricing / 07,12 | `PriceCalculator`, `PromotionService`, `BookingService`, `BookingRepository` | `BookingRulesTest`, `BookingFlowTest` | DEMO-07 | Done |
