...
<div class="container">
    <div class="tier-banner">
        <div class="tier-info">
            ...
            <p>
                ...
                Cấp độ: <strong><span id="userTier">Member</span></strong>
                <span id="tierBadge" class="tier-badge tier-member" style="margin-left:8px;">Member</span>
            </p>
        </div>
        <div class="next-tier">
            <div class="progress-text">Điểm hiện tại</div>
            <div class="progress-points"><span id="userPoints">0</span> điểm</div>
            <div>Cần thêm <strong><span id="pointsToNext">500</span></strong> điểm để lên hạng</div>
    ...
    <div class="dashboard-grid">
        ...
        <div class="stat-card tier">
            ...
            <div class="stat-label">Cấp độ thành viên</div>
        </div>
        <div class="stat-card">
            <div class="stat-icon">&#128663;</div>
            <div class="stat-value" id="totalBookingsCount">0</div>
            <div class="stat-label">Tổng lần đặt lịch</div>
        </div>
    </div>

    <div style="display:flex;gap:16px;flex-wrap:wrap;margin-bottom:20px;">
        <a href="booking_form.php" class="btn btn-primary">+ Đặt lịch ngay</a>
        <a href="history.php" class="btn btn-outline">Xem lịch sử</a>
    </div>

    <div class="card">
        <div class="card-header">
            <h3>Lịch sử đặt lịch gần đây</h3>
            <a href="history.php">Xem tất cả &rarr;</a>
        </div>
        <div class="table-wrapper">
            <table>
                ...
                <tbody id="recentBookings">
                    <tr><td colspan="5" style="text-align:center;color:#64748b;">Đang tải...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
