...
<form class="form-card" method="post" action="<?= $e($action) ?>">
    ...
    <div class="form-grid">
        ...
        <label class="form-field"><span>Giảm tối đa (reward phần trăm)</span><input inputmode="decimal" name="max_discount" value="<?= $e($values['max_discount']) ?>"><?= $error('max_discount') ?></label>
