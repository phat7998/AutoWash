...
if (localStorage.getItem('customerToken')) {
    document.getElementById('navLinks').innerHTML = '<li><a href="dashboard.php">Dashboard</a></li><li><a href="booking_form.php">Đặt lịch</a></li><li><a href="history.php">Lịch sử</a></li><li><a href="#" onclick="localStorage.removeItem(\'customerToken\');localStorage.removeItem(\'customerUser\');window.location.reload();return false;" class="btn-nav">Đăng xuất</a></li>';
}
</script>
